...
#        - 1. EmbeddingVectozier_W2V: (중분류 np.std, np.var 대분류 np.max, np.min) -> 1200개
...
# 5. Ensemble: Voting, Stacking: Voting submission 채택
...
mix = pd.concat([X_train_nm, X_train_mclas], axis=1)
